...
class Mailer extends CI_Controller {
    ...
    public function send() {       
        ...
        if($_POST['secret_key'] == $this->back_m->get_one('settings', 1)->catpcha_secret) {
            ...
            if(!$mail->send()) {
                ...
                $this->session->set_flashdata('flashdata', '<p class="font-weight-bold mb-0">Pomyślnie wysłałeś formularz!</p>');
                redirect('kontakt');
            }
        }else{
