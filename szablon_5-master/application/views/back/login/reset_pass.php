...
<html lang="en">
  ...
  <body>
    <form method="post" action="<?php echo base_url(); ?>panel/home/reset_pass" class="d-flex align-items-center justify-content-center bg-gray-900 ht-100v">
      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
        ...
        <div class="tx-center mg-b-60">Resetowanie hasła do panelu administracyjnego</div>
        ...
        <div class="form-group">
          <input type="text" class="form-control" name="email" placeholder="Wprowadź adres e-mail">
        </div>
        <div class="form-group">
          <a href="<?php echo base_url(); ?>panel" class="tx-info tx-12 d-block mg-t-10 link">&larr; Powrót do logowania</a>
        </div>
        <button type="submit" class="btn btn-info btn-block">Zresetuj hasło</button>
      </div>
    </form>
