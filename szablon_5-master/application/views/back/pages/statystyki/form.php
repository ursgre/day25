                    ...
                    <div class="row"> <!-- set -->
                        ...
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-l-0-force bd-r-0-force">
                                <label class="form-control-label">Liczba:</label>
                        ...
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force bd-b-0-force bd-r-0-force">
                                <label class="form-control-label">Znak specjalny:</label>
                                <input class="form-control" type="text" name="special_sign" value="<?php echo @$value->special_sign; ?>">
                            </div>
                        </div><!-- col-4 -->
                    </div> <!-- set -->
                    <div class="row">
