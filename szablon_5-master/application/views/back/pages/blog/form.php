            ...
            <div class="row no-gutters">
                <div class="col-md-8">
                    <div class="row"> <!-- set -->
                        ...
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-l-0-force bd-t-0-force">
                                <label class="form-control-label">Autor: <span class="tx-danger">*</span></label>
                                <input class="form-control" type="text" name="author" value="<?php echo @$value->author; ?>" required>
                            </div>
                        </div><!-- col-4 -->
                    </div> <!-- set -->
                    <div class="row"> <!-- set -->
                        ...
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-b-0-force">
                                <label class="form-control-label">Kontynuacja (w przypadku galerii po środku):</label>
                    ...
                    <div class="row"> <!-- set -->
                        <div class="col-md-6 pr-0">
                            <div class="form-group">
                                <label class="form-control-label">Tytuł (SEO): <span class="tx-danger">*</span></label>
                                <input class="form-control" type="text" name="title_seo" value="<?php echo @$value->title_seo; ?>" required>
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-md-6 px-0">
                            <div class="form-group bd-l-0-force">
                                <label class="form-control-label">Słowa kluczowe:</label>
                                <input class="form-control" type="text" name="keywords" value="<?php echo @$value->keywords; ?>">
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force bd-b-0-force">
                                <label class="form-control-label">Opis (SEO):</label>
                                <textarea class="summernote" name="description_seo"><?php echo @$value->description_seo; ?></textarea>
                            </div>
                        </div><!-- col-4 -->
                    </div> <!-- set -->
                    <div class="row">
